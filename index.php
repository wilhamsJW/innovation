...
<body>
  ...
  <header id="header">
    <div class="container d-flex align-items-center">
      ...
      <div class="logo mr-auto">
        <h1 class="text-light"><a href="index.php">WJSites<span>.</span></a></h1>
  ...
  <section id="hero">
    ...
    <div class="container">
      ...
      <div class=" col-lg-6 py-5 py-lg-0 order-2 order-lg-1" data-aos="fade-right">
        ...
        <h2>contato com o público alvo nas redes-sociais</h2>
        <h2>conquistas de novos consumidores</h2>
    ...
    <section id="portfolio" class="portfolio section-bg">
      <div class="container">
        ...
        <div class="row portfolio-container" data-aos="fade-up">
          ...
          <div class="col-lg-2 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              <img src="assets/img/port_site/site-118.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <a href="Projeto-118" target="blank"><h4>Visualizar Site</h4>
                <p>118</p></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-2 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              <img src="assets/img/port_site/site-119.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <a href="Projeto-119" target="blank"><h4>Visualizar Site</h4>
                <p>119</p></a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-2 col-md-6 portfolio-item filter-web">
            <div class="portfolio-wrap">
              <img src="assets/img/port_site/site-120.jpg" class="img-fluid" alt="">
              <div class="portfolio-info">
                <a href="Projeto-120" target="blank"><h4>Visualizar Site</h4>
                <p>120</p></a>
              </div>
            </div>
          </div>
  ...
  <footer id="footer">
    ...
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy; Copyright <strong><span>Wilhams</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        ...
        Designed by <a href="Wilhams Júnior">Wilhams Meira</a>
      </div>
    </div>
  </footer><!-- End Footer -->
